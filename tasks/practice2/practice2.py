...
def get_amount() -> float:
    ...
    # пиши код здесь
    amount = round(random.uniform(100, 1000001), 2)
    return amount
...
def is_phone_correct(phone_number: str) -> bool:
    ...
    # пиши код здесь
    result = phone_number[0:2] == '+7' and phone_number[2:].isnumeric() and len(phone_number) == 12
    return result
...
def moderate_text(text: str, uncultured_words: Iterable[str]) -> str:
    ...
    for unc_word in uncultured_words:
        text = text.replace(unc_word, '#' * len(unc_word))
    result = " ".join(text.capitalize().split())
    return result
...
def create_request_for_loan(user_info: str) -> str:
    ...
    result = f"Фамилия: {user_info_lst[0]}\nИмя: {user_info_lst[1]}\nОтчество: {user_info_lst[2]}\nДата рождения: {user_info_lst[3]}\nЗапрошенная сумма: {user_info_lst[4]}"
    return result
