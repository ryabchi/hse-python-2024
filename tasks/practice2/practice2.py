...
def is_phone_correct(phone_number: str) -> bool:
    ...
    second = phone_number[1] == '7'
    third = all(ch in '0123456789' for ch in phone_number[2:])
...
def is_amount_correct(current_amount: float, transfer_amount: str) -> bool:
    ...
    # пиши код здесь
    result = current_amount > float(transfer_amount) or math.isclose(current_amount, float(transfer_amount))
    return result
...
def create_request_for_loan(user_info: str) -> str:
    ...
    # пиши код здесь
    params = user_info.rstrip().split(',')
    result = '''Фамилия: {}
Имя: {}
Отчество: {}
Дата рождения: {}
Запрошенная сумма: {}'''.format(*params)
    return result