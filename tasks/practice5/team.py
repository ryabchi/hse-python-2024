...
class Team:
    ...
    def get_members(self) -> Set[Employee]:
        """
        Задача: реализовать метод возвращения списка участников команды так,
    ...
    def __str__(self):
        result = 'team: ' + self.name + ' manager: ' + self.manager.name + \
             ' number of members: ' + str(len(self.__members))
        return result
