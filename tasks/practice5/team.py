...
class Team:
    ...
    def add_member(self, member: Employee) -> None:
        ...
        if not isinstance(member, Employee):
            raise TypeError()
        return self.__members.add(member)
    ...
    def remove_member(self, member: Employee) -> None:
        ...
        if member in self.__members:
            return self.__members.remove(member)
        else:
    ...
    def __str__(self):
        return 'team: ' + self.name + ' manager: ' + self.manager.name + ' number of members: ' + str(len(self.get_members()))
    def show(self) -> None:
        """
        DO NOT EDIT!
