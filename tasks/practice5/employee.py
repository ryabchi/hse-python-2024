...
class Employee:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        # пиши свой код здесь
        if (not (isinstance(other, Employee))): raise TypeError
        try: return (get_position_level(self.position)==get_position_level(other.position))
        except NoSuchPositionError: raise ValueError
