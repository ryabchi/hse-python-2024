...
class Employee:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(self, Employee) or not isinstance(other, Employee):
            ...
            if self.position not in POSITIONS.keys() or other.position not in POSITIONS.keys():
                raise ValueError()
            return get_position_level(self.position) == get_position_level(other.__getattribute__('position'))
