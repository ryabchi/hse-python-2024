...
class Employee:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, Employee) or not isinstance(self, Employee):
            raise TypeError
        try:
...
class Developer(Employee):
    ...
    def __init__(self, name: str, salary: int, language: str, position: str = 'developer'):
        """
...
class Manager(Employee):
    ...
    def __init__(self, name: str, salary: int, position: str = 'manager'):
        """
        Задача: реализовать конструктор класса, используя конструктор родителя
        """
